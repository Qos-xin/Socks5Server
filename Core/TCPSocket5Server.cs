...
namespace Kingthy.Test.Socks5.Server.Core
{
    ...
    public class TCPSocks5Server
    {
        ...
        public TCPSocks5Server(ushort port, TCPSocket5Client socket5Client)
        {
            this.Port = port;
            this.socket5Client = socket5Client;
        }
        /// <summary>
        /// TCPSocks5Server
        /// </summary>
        ...
        public TCPSocket5Client socket5Client { get; set; }
        /// <summary>
        /// 绑定的端口号
        /// </summary>
        public ushort Port
        ...
        private void OnBeginAcceptSocket(IAsyncResult async)
        {
            ...
            try
            {
                ...
                TCPSocks5Connection.DoRequest(this, socket5Client, client);
                if (this.IsStarting)
                {
